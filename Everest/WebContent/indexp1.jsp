<div class="row">
            <div class="col-md-4">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body" id="centralzone" onclick="loadPage('centralzone');">
            ...
            <div class="col-md-4">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body" id="eastzone" onclick="loadPage('eastzone');">
                    <img src="images/barchart.jpg" style="width:100%; height:100% ">
            ...
            <div class="col-md-4">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body" id="westzone" onclick="loadPage('westzone');">
            ...
            <div class="col-md-4">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body" id="northzone" onclick="loadPage('northzone');">
                       <img src="images/barchart.jpg" style="width:100%; height:100% ">
                        <a href="#" class="btn btn-default">Know More</a>
                    </div>
                </div>
            ...
            <div class="col-md-4">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body" id="southzone" onclick="loadPage('southzone');">
                       <img src="images/barchart.jpg" style="width:100%; height:100% ">
                        <a href="#" class="btn btn-default">Know More</a>
                    </div>
                </div>
